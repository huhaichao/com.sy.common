...
public class SnCal {
		...
		public String toLicCode(String address,String location,String radius,String sk) throws UnsupportedEncodingException, NoSuchAlgorithmException {
               ...
               //该方法会自动将key按照字母a-z顺序排序。所以get请求可自定义参数顺序（sn参数必须在最后）发送请求，
                ...
                //以get请求为例：http://api.map.baidu.com/geocoder/v2/?address=百度大厦&output=json&ak=yourak，paramsMap中先放入address，再放output，
                //然后放ak，放入顺序必须跟get请求中对应参数的出现顺序保持一致。
