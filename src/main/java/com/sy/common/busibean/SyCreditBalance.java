...
public class SyCreditBalance {
    private Integer tSyCreditBalanceId;
    ...
    public Integer gettSyCreditBalanceId() {
        return tSyCreditBalanceId;
    }

    public void settSyCreditBalanceId(Integer tSyCreditBalanceId) {
        this.tSyCreditBalanceId = tSyCreditBalanceId;
    }
